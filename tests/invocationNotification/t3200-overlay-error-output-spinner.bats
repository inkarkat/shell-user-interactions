...
@test "multi-line error from the command powers a spinner after the message as the command runs" {
    run invocationNotification --to overlay --message 'message: ' --spinner-stderr --command "$MULTI_LINE_COMMAND"
...
@test "full spin cycle" {
    run invocationNotification --to overlay --message 'message: ' --spinner-stderr --command 'seq 1 5 >&2'
...
@test "multi-line error from the command powers a spinner after the message and sigil as the command runs" {
    run invocationNotification --to overlay --message 'message: ' --spinner-stderr --success OK --command "$MULTI_LINE_COMMAND"
...
@test "multi-line error from the command powers a spinner and then cleared" {
    run invocationNotification --to overlay --message 'message: ' --spinner-stderr --clear all --command "$MULTI_LINE_COMMAND"
...
@test "multi-line error from the command powers a spinner and then cleared with sigil" {
    run invocationNotification --to overlay --message 'message: ' --spinner-stderr --clear all --success OK --command "$MULTI_LINE_COMMAND"
...
@test "multi-line error that contains the statusline marker does not rotate the spinner" {
    run invocationNotification --to overlay --message 'message: ' --spinner-stderr --command '{ echo first; echo \#-\#666; echo last; } >&2'
