...
@test "append count of reports" {
    runWithInput $'first\nsecond\nthird' progressNotification --to overlay --timespan 0 --count report
    [ $status -eq 0 ]
