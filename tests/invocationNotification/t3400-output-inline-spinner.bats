...
@test "multi-line output from the command is individually appended / error output rotates the spinner and final sigil" {
    run invocationNotification --to overlay --message 'message: ' --timespan 0 --inline-spinner-stderr --success OK --command "$MIXED_COMMAND"
...
@test "multi-line output from the command is individually appended / error output rotates the spinner and then cleared" {
    run invocationNotification --to overlay --message 'message: ' --timespan 0 --inline-spinner-stderr --clear all --command "$MIXED_COMMAND"
...
@test "multi-line output from the command is individually appended / error output rotates the spinner and then cleared with sigil" {
    run invocationNotification --to overlay --message 'message: ' --timespan 0 --inline-spinner-stderr --clear all --success OK --command "$MIXED_COMMAND"
